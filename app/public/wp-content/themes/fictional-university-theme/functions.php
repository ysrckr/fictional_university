...
{
    wp_enqueue_script('googleMap', 'https://maps.googleapis.com/maps/api/js?key=AIzaSyDaKMHpL0tisG707Ku_HpHCxTfWrExdE58', null, '1.0.0', true);
...
{
    $api['key'] = 'AIzaSyDaKMHpL0tisG707Ku_HpHCxTfWrExdE58';
    return $api;
};
add_filter('acf/fields/google_map/api', 'universityMapKey');

//Redirect Subscriber Users to Home Page
